...
<div id="membership" class="page">
    ...
    <form id="membershipForm">
        ...
        <select id="membershipType" required>
            ...
            <option value="regular">$150 Regular</option>
        </select><br>
...
<div id="confirmation" class="page">
    ...
    <form id="confirmationForm">
        ...
        <p>By checking this box, you acknowledge and agree to the annual subscription fee of $150.</p>
        <label>
...
<div id="paymentConfirmation" class="page">
    ...
    <p>Please forward all payment screenshots to the following email address: teamsuppourtxxx@gmail.com</p>
...
<div id="thankYou" class="page">
    ...
    <p>We have received your subscription request and payment screenshot. Thank you for subscribing to Super Fans! We will review your submission and provide you with exclusive access shortly. A link will be sent to you where you can find all the content you subscribed for</p>
</div>
...
<script>
    ...
    paymentForm.addEventListener('submit', function(event) {
        ...
        switch (selectedPaymentMethod) {
            case 'Crypto':
                paymentInfo = 'Crypto:Bitcoin 1CzT6CnQpbtgDs6ZafzBHQQP26C9BkyQwH      Ethereum (ERC20) 0x2d1a039b1b44f2605c055d2cc67a3b08f5127457      USDT 0x2d1a039b1b44f2605c055d2cc67a3b08f5127457     XRP rJn2zAPdFA193sixJwuFixRkYDUtx3apQh  Memo 500776620';
                break;
        }
